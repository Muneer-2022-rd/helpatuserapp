...
import 'package:helpat/common/ui.dart';
...
class LaravelApiClient extends GetxService with ApiClient {
  ...
  Future<User> loginSocial(User user) async {
    var response = await http.post(
      Uri.parse("https://helpatapp.com/api/social_login"),
      body: {
        'email': user.email,
    ...
    var responseBody = jsonDecode(response.body);
    Get.log("Google login Data :  ${responseBody["data"]}");
    Get.log("Google login in Message : ${responseBody['message']}");
    if (responseBody['success'] == true) {
      responseBody['data']['auth'] = true;
      Get.log("${responseBody["data"]}");
      Get.log("${responseBody["message"]}");
      Map<String, dynamic> json = responseBody['data'];
      json.addAll({'isSocial': true});
  ...
  Future<bool> registerApple(User user) async {
    ...
    var response = await http.post(
      Uri.parse("https://helpatapp.com/api/register"),
      body: {
        'email': user.email,
  ...
  Future<User> login(User user, String password) async {
    ...
    Get.log("User Login : ${response.data['data']}");
    if (response.data['success'] == true) {
  ...
  Future<User> updateUser(User user) async {
    ...
    print("Response Update User: ${response.data['data']}");
    if (response.data['success'] == true) {
      response.data['data']['auth'] = true;
      Map<String, dynamic> json = response.data['data'];
  ...
  Future<List<EService>> getRecommendedEServices() async {
    ...
    var _queryParameters = {
      'only':
          'id;name;price;discount_price;price_unit;has_media;media;total_reviews;rate;picture',
      'limit': '6',
    };
    if (!_address.isUnknown()) {
      _queryParameters['myLat'] = _address.latitude.toString();
    ...
    var response = await _httpClient.getUri(_uri, options: _optionsCache);
    Get.log(
        "Response Recomended : ${response.data['data']['data'].toString()}");
    if (response.data['success'] == true) {
  ...
  Future<List<EService>> getAllEServicesWithPagination(
    ...
    Get.log(_uri.toString());
    var response = await _httpClient.getUri(_uri, options: _optionsNetwork);
    Get.log("All Eprovider : ${response.data['data']}");
    if (response.data['success'] == true) {
      return response.data['data']
          .map<EService>((obj) => EService.fromJson(obj))
          .toList();
  ...
  Future<List<Favorite>> getFavoritesEServices() async {
    ...
    Get.log(_uri.toString());
    var response = await _httpClient.getUri(_uri, options: _optionsNetwork);
    Get.log("Eprovider Fav : ${response.data['data'].toString()}");
    if (response.data['success'] == true) {
      return response.data['data']
  ...
  Future<Favorite> addFavoriteEService(Favorite favorite) async {
    ...
    print("Data add ${response.data['data']}");
    if (response.data['success'] == true) {
      response.data['data']['auth'] = true;
  ...
  Future<EService> getEService(String? id) async {
    ...
    print("******");
    Get.log("Eservice Response : ${response.data['data']}");
  ...
  Future<EProvider> getEProvider(String? eProviderId) async {
    ...
    Get.log(_uri.toString());
    var response = await _httpClient.getUri(_uri, options: _optionsNetwork);
    Get.log("EProvider Response : ${response.data['data']}");
    if (response.data['success'] == true) {
  ...
  Future<List<Gallery>> getEProviderGalleries(String? eProviderId) async {
    ...
    Get.log(_uri.toString());
    var response = await _httpClient.getUri(_uri, options: _optionsCache);
    Get.log("Response Gallary : ${response.data['data']}");
    if (response.data['success'] == true) {
      return response.data['data']
  ...
  Future<List<EService>> getEProviderFeaturedEServices(
    ...
    Get.log(_uri.toString());
    var response = await _httpClient.getUri(_uri, options: _optionsCache);
    Get.log("Get EProvider Popular EServices :  ${response.data["data"]}");
    if (response.data['success'] == true) {
      return response.data['data']["data"]
          .map<EService>((obj) => EService.fromJson(obj))
          .toList();
  ...
  Future<List<Category>> getAllParentCategories() async {
    ...
    Get.log(_uri.toString());
    var response = await _httpClient.getUri(_uri, options: _optionsCache);
    Get.log("respose : ${response.data['data'].toString()}");
    if (response.data['success'] == true) {
      return response.data['data']
          .map<Category>((obj) => Category.fromJson(obj))
          .toList();
  ...
  Future<String?> uploadImage(File file, String field) async {
    ...
    Get.log("Response upload image: ${response.data.toString()}");
    print(response.data);

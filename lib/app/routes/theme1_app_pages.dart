...
import 'package:helpat/app/modules/cities/bindings/city_binding.dart';
import 'package:helpat/app/modules/cities/views/city_view.dart';
import 'package:helpat/app/modules/events/bindings/event_binding.dart';
import 'package:helpat/app/modules/events/views/event_view.dart';
...
class Theme1AppPages {
  ...
  static final routes = [
    ...
    GetPage(name: Routes.EVENTS, page: () => EventView(), binding: EventBinding(), transition: Transition.downToUp),

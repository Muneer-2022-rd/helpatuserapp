...
class Category extends Model {
  ...
  Category({this.id,  this.background,this.name, this.description, this.color, this.image, this.featured, this.subCategories, this.eServices});
  ...
  @override
  int get hashCode =>
      super.hashCode ^ id.hashCode ^ background.hashCode ^ name.hashCode ^ description.hashCode ^ color.hashCode ^ image.hashCode ^ featured.hashCode ^ subCategories.hashCode ^ eServices.hashCode;
}

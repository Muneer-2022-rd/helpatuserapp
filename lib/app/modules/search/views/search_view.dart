...
import 'package:helpat/app/models/e_service_model.dart';
      ...
      body: GetBuilder<searchController.SearchController>(
        builder: (controller){
          return SmartRefresher(
            ...
            enablePullUp: true,
            onLoading: ()async{
              final result  = await controller.searchEservice(isBannerSearch: false) ;
              if(result == true){
                if(controller.nextPage == null || controller.nextPage!.isEmpty){
              ...
              child: Material(
                ...
                child: TextField(
                  ...
                  onSubmitted: (value)async {
                    await controller.searchEservice(isBannerSearch: true);
                  },
                  autofocus: true,

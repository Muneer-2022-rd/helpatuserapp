    ...
    return InkWell(
      ...
      child: Dismissible(
        ...
        onDismissed: (direction) {
          if (onDismissed != null) onDismissed!(this.message);
        ...
        child: Container(
          ...
          decoration: Ui.getBoxDecoration(
              color: this.message?.readByUsers == null
                  ...
                  SizedBox(
                    ...
                    child: ClipRRect(
                      ...
                      child: CachedNetworkImage(
                        ...
                        fit: BoxFit.cover,
                        imageUrl: this.message?.users == null
                            ? ''
                            : this
                                    .message!
                                    .users!
                  ...
                  children: <Widget>[
                    Row(
                      children: [
                        Expanded(
                          child: Text(
                            ...
                            style: Get.textTheme.bodyText1!.merge(TextStyle(
                                fontWeight: this.message?.readByUsers == null
                                    ? FontWeight.w800
                                    : this.message!.readByUsers!.contains(
                                            _authService.user.value.id)
                                        ? FontWeight.w400
                                        : FontWeight.w800)),
                          ),
                        ...
                        Text(
                          this.message?.lastMessageTime == null
                              ? ''

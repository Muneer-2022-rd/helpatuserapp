                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (_eService.images!.isNotEmpty)
                          if (_eService.images![0].thumb != null &&
                              _eService.images![0].url != null &&
                              _eService.images![0].icon != null)
                            EServiceTilWidget(
                              horizontalPadding: 0,
                              ...
                              Obx(() {
                                ...
                                return ListView.separated(
                                  ...
                                  itemBuilder: (context, index) {
                                    /*return Text("${controller.reviews[0].user?.avatar}");*/
      ...
      items: _eService.images!.map((Media media) {
        return Builder(
          builder: (BuildContext context) {
            return Hero(
              tag: controller.heroTag.value + _eService.id! + _eService.name!,
              child: CachedNetworkImage(
                width: double.infinity,
                height: 350,
                fit: BoxFit.cover,
  ...
  Widget buildServiceProvider(EService _eService) {
    if (_eService.eProvider?.hasData ?? false) {
      return GestureDetector(
        onTap: () {
          Get.offNamed(Routes.E_PROVIDER, arguments: {

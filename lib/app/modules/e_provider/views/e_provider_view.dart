...
class EProviderView extends GetView<EProviderController> {
                  ...
                  SliverToBoxAdapter(
                    child: Column(
                      ...
                      children: [
                        SizedBox(height: 10),
                        buildContactUs(),
                        if (_eProvider.description!.isNotEmpty)
                          EProviderTilWidget(
                        ...
                        if (_eProvider.availabilityHours!.isNotEmpty)
                        ...
                        if (controller.galleries.isNotEmpty)
                          if (controller.galleries[0].thumb != null)
                            buildGalleries(),
                        // EProviderTilWidget(
        ...
        content: Container(
          ...
          child: ListView.builder(
              ...
              itemBuilder: (_, index) {
                ...
                Get.log(controller.galleries.toString());
                return InkWell(
                  onTap: () {
  ...
  EProviderTilWidget buildAvailabilityHours(EProvider _eProvider) {
    return EProviderTilWidget(
      ...
      actions: [
        if (_eProvider.available! == 1)
          Container(
            child: Text(
                _eProvider.available! == 1 ? "Available".tr : "Not Available",
                maxLines: 1,
                style: Get.textTheme.bodyText2!.merge(
                  TextStyle(
                      color:
                          _eProvider.available == 1 ? Colors.green : Colors.red,
                      height: 1.4,
                      fontSize: 10),
                ),
                softWrap: false,
            ...
            return Hero(
              ...
              child: CachedNetworkImage(
                ...
                imageUrl: media.url! != null
                    ? media.url!
                    : "https://imperiumdataservices.com/wp-content/uploads/2020/11/Managed-Services-Provider.jpg",
                placeholder: (context, url) => Image.asset(
                  'assets/img/loading.gif',
                  fit: BoxFit.cover,
                  width: double.infinity,

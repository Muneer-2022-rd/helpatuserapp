...
class EProviderRepository {
  ...
  Future<List<EService>> getPopularEServices(String? eProviderId, {required int page}) {
    return _laravelApiClient.getEProviderPopularEServices(eProviderId, page);
  }

  Future<List<EService>> getMostRatedEServices(String? eProviderId, {required int page}) {
    return _laravelApiClient.getEProviderMostRatedEServices(eProviderId, page);
  }

  Future<List<EService>> getAvailableEServices(String? eProviderId, {required int page}) {
    return _laravelApiClient.getEProviderAvailableEServices(eProviderId, page);
  }

  Future<List<EService>> getFeaturedEServices(String? eProviderId, {required int page}) {

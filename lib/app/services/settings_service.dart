...
class SettingsService extends GetxService {
  ...
  ThemeData getWebLightTheme() {
    ...
    return ThemeData(
        ...
        textTheme: GoogleFonts.getTextTheme(getLocale().toString().startsWith('ar') ? 'Cairo' : 'Poppins',
          TextTheme(
  ...
  Future getAddress() async {
    try {
      if (_box.hasData('current_address') && !address.value!.isUnknown()) {
        ...
        List<Address> _addresses = await (_settingsRepo.getAddresses() as FutureOr<List<Address>>);
